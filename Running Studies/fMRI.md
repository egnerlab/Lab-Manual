...
```
        ...
        First name (and preferred first name):<br>
        Last name:<br>
        Duke NetID:<br>
        Duke UniqueID:<br>
        DukeCard#:<br>
        ...
        Renewal period: 12 months<br>
        BIAC Sponsor: Dr. Tobias Egner<br>
        BIAC Sponsor email: tobias.egner@duke.edu<br>
...
1. You will need to phone screen participants the day before they are run/1-2 days. To screen them, you will call them and go through the BIAC screening form to confirm they are eligible (even though they should already be eligible since they are in the pool already, and they again have to complete the screening form the day of the study).
2.
